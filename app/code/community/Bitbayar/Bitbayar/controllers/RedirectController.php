...
class Bitbayar_Bitbayar_RedirectController extends Mage_Core_Controller_Front_Action
{
	...
	public function cancelAction() {
		...
		if(!$order->isPaymentReview() || $order->hasInvoices()) {
			...
			Mage::dispatchEvent('bitbayar_order_cancelled', array('order_id' => $orderId));
		}
